			...
			foreach ($komponen as $rom) : ?>
				...
				foreach ($komponen_sub as $row) : ?>
					<tr>
						...
						<?php $NilaiSum_utama = $db->table('tb_sakip_instansi_jawaban_lhe')
							->selectSum('nilai')
							->join('tb_sakip_instansi', 'tb_sakip_instansi_jawaban_lhe.sakip_instansi_id = tb_sakip_instansi.id_sakip_instansi', 'LEFT')
							->join('tb_sakip_opd', 'tb_sakip_instansi_jawaban_lhe.opd_id = tb_sakip_opd.opd_id', 'LEFT')
							->getWhere([
						...
						<?php $NilaiSum_pendukung = $db->table('tb_sakip_instansi_jawaban_lhe')
							->selectSum('nilai')
							->join('tb_sakip_instansi', 'tb_sakip_instansi_jawaban_lhe.sakip_instansi_id = tb_sakip_instansi.id_sakip_instansi', 'LEFT')
							->join('tb_sakip_opd', 'tb_sakip_instansi_jawaban_lhe.opd_id = tb_sakip_opd.opd_id', 'LEFT')
							->getWhere([
						...
						<?php $NilaiSum_tambahan = $db->table('tb_sakip_instansi_jawaban_lhe')
							->selectSum('nilai')
							->join('tb_sakip_instansi', 'tb_sakip_instansi_jawaban_lhe.sakip_instansi_id = tb_sakip_instansi.id_sakip_instansi', 'LEFT')
							->join('tb_sakip_opd', 'tb_sakip_instansi_jawaban_lhe.opd_id = tb_sakip_opd.opd_id', 'LEFT')
							->getWhere([
